...
2. Does tempo text also cover character words that are not tempos ("dolce", "maestoso"), or do those belong to text directions in [Marks on Notes](marks-on-notes.md)?
