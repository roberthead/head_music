...
Produced by `bin/guide_grade_corpus.rb`, run at the merge-base and again
at the tip. The script takes no arguments beyond the output path and asks
only what both trees can answer, so the two columns are the same
...
**3266 rows** — 142 corpus entries × 23 registry entries. 1944 moved,
1322 unchanged. An asterisk marks an unassessable voice.
...
- **demoted** — the species guides weigh what they teach above what they inherit.
...
| solo-ascending-1 | 1 | `fux_cantus_firmus` | 0.125 | 0.333* | 0.208 | no | demoted |
| solo-ascending-1 | 1 | `salzer_schachter_cantus_firmus` | 0.125 | 0.333* | 0.208 | no | demoted |
| solo-ascending-1 | 1 | `diatonic_melody` | 0.200 | 0.333* | 0.133 | no | demoted |
...
| solo-ascending-1 | 1 | `static_contour_melody` | 0.200 | 0.333* | 0.133 | no | demoted |
| solo-ascending-2 | 2 | `fux_cantus_firmus` | 0.230 | 0.667* | 0.437 | no | demoted |
| solo-ascending-2 | 2 | `salzer_schachter_cantus_firmus` | 0.235 | 0.667* | 0.432 | no | demoted |
| solo-ascending-2 | 2 | `diatonic_melody` | 0.391 | 0.667* | 0.275 | no | demoted |
...
| solo-ascending-2 | 2 | `arch_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| solo-ascending-2 | 2 | `ascending_contour_melody` | 0.397 | 0.667* | 0.270 | no | demoted |
| solo-ascending-2 | 2 | `descending_contour_melody` | 0.244 | 0.667* | 0.423 | no | demoted |
| solo-ascending-2 | 2 | `static_contour_melody` | 0.244 | 0.667* | 0.423 | no | demoted |
| solo-ascending-2 | 2 | `valley_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| solo-ascending-2 | 2 | `wave_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| solo-ascending-3 | 3 | `fux_cantus_firmus` | 0.365 | 0.937 | 0.572 | yes | demoted |
| solo-ascending-3 | 3 | `salzer_schachter_cantus_firmus` | 0.366 | 0.941 | 0.575 | yes | demoted |
| solo-ascending-3 | 3 | `diatonic_melody` | 0.600 | 0.964 | 0.364 | yes | demoted |
...
| solo-ascending-3 | 3 | `arch_contour_melody` | 0.600 | 0.986 | 0.386 | yes | demoted |
| solo-ascending-3 | 3 | `ascending_contour_melody` | 0.371 | 0.604 | 0.233 | yes | demoted |
| solo-ascending-3 | 3 | `descending_contour_melody` | 0.371 | 0.604 | 0.233 | yes | demoted |
| solo-ascending-3 | 3 | `static_contour_melody` | 0.600 | 0.986 | 0.386 | yes | demoted |
| solo-ascending-3 | 3 | `valley_contour_melody` | 0.371 | 0.604 | 0.233 | yes | demoted |
| solo-ascending-3 | 3 | `wave_contour_melody` | 0.371 | 0.604 | 0.233 | yes | demoted |
| solo-ascending-4 | 4 | `fux_cantus_firmus` | 0.454 | 0.882 | 0.428 | yes | demoted |
| solo-ascending-4 | 4 | `salzer_schachter_cantus_firmus` | 0.464 | 0.903 | 0.439 | yes | demoted |
| solo-ascending-4 | 4 | `diatonic_melody` | 0.769 | 0.947 | 0.178 | yes | demoted |
...
| solo-ascending-4 | 4 | `arch_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| solo-ascending-4 | 4 | `ascending_contour_melody` | 0.788 | 0.980 | 0.191 | yes | demoted |
| solo-ascending-4 | 4 | `descending_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| solo-ascending-4 | 4 | `static_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| solo-ascending-4 | 4 | `valley_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| solo-ascending-4 | 4 | `wave_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| solo-ascending-5 | 5 | `fux_cantus_firmus` | 0.609 | 0.953 | 0.344 | yes | demoted |
| solo-ascending-5 | 5 | `salzer_schachter_cantus_firmus` | 0.610 | 0.955 | 0.345 | yes | demoted |
...
| solo-ascending-6 | 6 | `fux_cantus_firmus` | 0.700 | 0.922 | 0.222 | yes | demoted |
| solo-ascending-6 | 6 | `salzer_schachter_cantus_firmus` | 0.714 | 0.940 | 0.226 | yes | demoted |
...
| solo-ascending-7 | 7 | `fux_cantus_firmus` | 0.853 | 0.968 | 0.116 | yes | demoted |
| solo-ascending-7 | 7 | `salzer_schachter_cantus_firmus` | 0.854 | 0.970 | 0.116 | yes | demoted |
...
| solo-ascending-8 | 8 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| solo-ascending-8 | 8 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| solo-repeated-1 | 1 | `fux_cantus_firmus` | 0.115 | 0.333* | 0.218 | no | demoted |
| solo-repeated-1 | 1 | `salzer_schachter_cantus_firmus` | 0.116 | 0.333* | 0.217 | no | demoted |
| solo-repeated-1 | 1 | `diatonic_melody` | 0.192 | 0.333* | 0.141 | no | demoted |
...
| solo-repeated-1 | 1 | `static_contour_melody` | 0.197 | 0.333* | 0.136 | no | demoted |
| solo-repeated-2 | 2 | `fux_cantus_firmus` | 0.207 | 0.667* | 0.460 | no | demoted |
| solo-repeated-2 | 2 | `salzer_schachter_cantus_firmus` | 0.213 | 0.667* | 0.454 | no | demoted |
| solo-repeated-2 | 2 | `diatonic_melody` | 0.367 | 0.667* | 0.300 | no | demoted |
...
| solo-repeated-2 | 2 | `static_contour_melody` | 0.387 | 0.667* | 0.279 | no | demoted |
| solo-repeated-3 | 3 | `fux_cantus_firmus` | 0.296 | 0.764 | 0.468 | yes | demoted |
| solo-repeated-3 | 3 | `salzer_schachter_cantus_firmus` | 0.307 | 0.792 | 0.485 | yes | demoted |
| solo-repeated-3 | 3 | `diatonic_melody` | 0.531 | 0.859 | 0.328 | yes | demoted |
...
| solo-repeated-3 | 3 | `static_contour_melody` | 0.574 | 0.946 | 0.373 | yes | demoted |
| solo-repeated-4 | 4 | `fux_cantus_firmus` | 0.370 | 0.725 | 0.355 | yes | demoted |
| solo-repeated-4 | 4 | `salzer_schachter_cantus_firmus` | 0.398 | 0.778 | 0.380 | yes | demoted |
| solo-repeated-4 | 4 | `diatonic_melody` | 0.691 | 0.857 | 0.167 | yes | demoted |
...
| solo-repeated-4 | 4 | `static_contour_melody` | 0.758 | 0.946 | 0.187 | yes | demoted |
| solo-repeated-5 | 5 | `fux_cantus_firmus` | 0.448 | 0.710 | 0.263 | yes | demoted |
| solo-repeated-5 | 5 | `salzer_schachter_cantus_firmus` | 0.487 | 0.770 | 0.283 | yes | demoted |
| solo-repeated-5 | 5 | `diatonic_melody` | 0.847 | 0.861 | 0.014 | yes | demoted |
...
| solo-repeated-5 | 5 | `static_contour_melody` | 0.942 | 0.947 | 0.005 | yes | demoted |
| solo-repeated-6 | 6 | `fux_cantus_firmus` | 0.525 | 0.703 | 0.178 | yes | demoted |
| solo-repeated-6 | 6 | `salzer_schachter_cantus_firmus` | 0.559 | 0.745 | 0.187 | yes | demoted |
| solo-repeated-6 | 6 | `diatonic_melody` | 0.797 | 0.816 | 0.018 | yes | demoted |
...
| solo-repeated-6 | 6 | `static_contour_melody` | 0.923 | 0.930 | 0.007 | yes | demoted |
| solo-repeated-7 | 7 | `fux_cantus_firmus` | 0.602 | 0.700 | 0.098 | yes | demoted |
| solo-repeated-7 | 7 | `salzer_schachter_cantus_firmus` | 0.639 | 0.739 | 0.100 | yes | demoted |
| solo-repeated-7 | 7 | `diatonic_melody` | 0.778 | 0.798 | 0.020 | yes | demoted |
...
| solo-repeated-7 | 7 | `static_contour_melody` | 0.915 | 0.923 | 0.008 | yes | demoted |
| solo-repeated-8 | 8 | `fux_cantus_firmus` | 0.680 | 0.700 | 0.020 | yes | demoted |
| solo-repeated-8 | 8 | `salzer_schachter_cantus_firmus` | 0.721 | 0.737 | 0.016 | yes | demoted |
| solo-repeated-8 | 8 | `diatonic_melody` | 0.764 | 0.786 | 0.021 | yes | demoted |
...
| solo-repeated-8 | 8 | `static_contour_melody` | 0.910 | 0.918 | 0.008 | yes | demoted |
...
| against-empty-1 | 1 | `fux_cantus_firmus` | 0.125 | 0.333* | 0.208 | no | demoted |
| against-empty-1 | 1 | `salzer_schachter_cantus_firmus` | 0.125 | 0.333* | 0.208 | no | demoted |
| against-empty-1 | 1 | `diatonic_melody` | 0.200 | 0.333* | 0.133 | no | demoted |
...
| against-empty-1 | 1 | `static_contour_melody` | 0.200 | 0.333* | 0.133 | no | demoted |
| against-empty-2 | 2 | `fux_cantus_firmus` | 0.230 | 0.667* | 0.437 | no | demoted |
| against-empty-2 | 2 | `salzer_schachter_cantus_firmus` | 0.235 | 0.667* | 0.432 | no | demoted |
| against-empty-2 | 2 | `diatonic_melody` | 0.391 | 0.667* | 0.275 | no | demoted |
...
| against-empty-2 | 2 | `arch_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| against-empty-2 | 2 | `ascending_contour_melody` | 0.397 | 0.667* | 0.270 | no | demoted |
| against-empty-2 | 2 | `descending_contour_melody` | 0.244 | 0.667* | 0.423 | no | demoted |
| against-empty-2 | 2 | `static_contour_melody` | 0.244 | 0.667* | 0.423 | no | demoted |
| against-empty-2 | 2 | `valley_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| against-empty-2 | 2 | `wave_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| against-empty-4 | 4 | `fux_cantus_firmus` | 0.454 | 0.882 | 0.428 | yes | demoted |
| against-empty-4 | 4 | `salzer_schachter_cantus_firmus` | 0.464 | 0.903 | 0.439 | yes | demoted |
| against-empty-4 | 4 | `diatonic_melody` | 0.769 | 0.947 | 0.178 | yes | demoted |
...
| against-empty-4 | 4 | `arch_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-empty-4 | 4 | `ascending_contour_melody` | 0.788 | 0.980 | 0.191 | yes | demoted |
| against-empty-4 | 4 | `descending_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-empty-4 | 4 | `static_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-empty-4 | 4 | `valley_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-empty-4 | 4 | `wave_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-empty-8 | 8 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| against-empty-8 | 8 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| against-cantus-1 | 1 | `fux_cantus_firmus` | 0.125 | 0.333* | 0.208 | no | demoted |
| against-cantus-1 | 1 | `salzer_schachter_cantus_firmus` | 0.125 | 0.333* | 0.208 | no | demoted |
| against-cantus-1 | 1 | `diatonic_melody` | 0.200 | 0.333* | 0.133 | no | demoted |
...
| against-cantus-1 | 1 | `static_contour_melody` | 0.200 | 0.333* | 0.133 | no | demoted |
| against-cantus-2 | 2 | `fux_cantus_firmus` | 0.230 | 0.667* | 0.437 | no | demoted |
| against-cantus-2 | 2 | `salzer_schachter_cantus_firmus` | 0.235 | 0.667* | 0.432 | no | demoted |
| against-cantus-2 | 2 | `diatonic_melody` | 0.391 | 0.667* | 0.275 | no | demoted |
...
| against-cantus-2 | 2 | `arch_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| against-cantus-2 | 2 | `ascending_contour_melody` | 0.397 | 0.667* | 0.270 | no | demoted |
| against-cantus-2 | 2 | `descending_contour_melody` | 0.244 | 0.667* | 0.423 | no | demoted |
| against-cantus-2 | 2 | `static_contour_melody` | 0.244 | 0.667* | 0.423 | no | demoted |
| against-cantus-2 | 2 | `valley_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| against-cantus-2 | 2 | `wave_contour_melody` | 0.122 | 0.333* | 0.211 | no | demoted |
| against-cantus-4 | 4 | `fux_cantus_firmus` | 0.454 | 0.882 | 0.428 | yes | demoted |
| against-cantus-4 | 4 | `salzer_schachter_cantus_firmus` | 0.464 | 0.903 | 0.439 | yes | demoted |
| against-cantus-4 | 4 | `diatonic_melody` | 0.769 | 0.947 | 0.178 | yes | demoted |
...
| against-cantus-4 | 4 | `arch_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-cantus-4 | 4 | `ascending_contour_melody` | 0.788 | 0.980 | 0.191 | yes | demoted |
| against-cantus-4 | 4 | `descending_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-cantus-4 | 4 | `static_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-cantus-4 | 4 | `valley_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-cantus-4 | 4 | `wave_contour_melody` | 0.483 | 0.598 | 0.115 | yes | demoted |
| against-cantus-8 | 8 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| against-cantus-8 | 8 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| schoenberg_cantus_firmus_examples-1-v0 | 8 | `fux_cantus_firmus` | 0.949 | 0.952 | 0.003 | yes | demoted |
...
| davis_and_lybbert_cantus_firmus_examples-0-v0 | 10 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| davis_and_lybbert_cantus_firmus_examples-1-v0 | 9 | `fux_cantus_firmus` | 0.970 | 0.972 | 0.002 | yes | demoted |
...
| davis_and_lybbert_cantus_firmus_examples-4-v0 | 10 | `fux_cantus_firmus` | 0.959 | 0.961 | 0.003 | yes | demoted |
...
| davis_and_lybbert_cantus_firmus_examples-6-v0 | 10 | `fux_cantus_firmus` | 0.967 | 0.969 | 0.002 | yes | demoted |
...
| davis_and_lybbert_cantus_firmus_examples-7-v0 | 10 | `fux_cantus_firmus` | 0.959 | 0.961 | 0.003 | yes | demoted |
...
| davis_and_lybbert_cantus_firmus_examples-8-v0 | 11 | `fux_cantus_firmus` | 0.978 | 0.980 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-0-v0 | 12 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-0-v0 | 12 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-1-v0 | 7 | `fux_cantus_firmus` | 0.858 | 0.974 | 0.116 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-1-v0 | 7 | `salzer_schachter_cantus_firmus` | 0.875 | 0.993 | 0.118 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `diatonic_melody` | 0.962 | 0.965 | 0.003 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `arch_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `ascending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `descending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `static_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `valley_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-2-v0 | 11 | `wave_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `fux_cantus_firmus` | 0.992 | 0.992 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `salzer_schachter_cantus_firmus` | 0.992 | 0.993 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `diatonic_melody` | 0.988 | 0.989 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `arch_contour_melody` | 0.995 | 0.996 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `ascending_contour_melody` | 0.613 | 0.614 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `descending_contour_melody` | 0.613 | 0.614 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `static_contour_melody` | 0.613 | 0.614 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `valley_contour_melody` | 0.613 | 0.614 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-3-v0 | 11 | `wave_contour_melody` | 0.995 | 0.996 | 0.000 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-4-v0 | 9 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-4-v0 | 9 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-5-v0 | 8 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `fux_cantus_firmus` | 0.933 | 0.938 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `salzer_schachter_cantus_firmus` | 0.923 | 0.927 | 0.005 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `diatonic_melody` | 0.876 | 0.888 | 0.011 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `arch_contour_melody` | 0.953 | 0.957 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `ascending_contour_melody` | 0.571 | 0.575 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `descending_contour_melody` | 0.571 | 0.575 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `static_contour_melody` | 0.571 | 0.575 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `valley_contour_melody` | 0.571 | 0.575 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-6-v0 | 14 | `wave_contour_melody` | 0.953 | 0.957 | 0.004 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `fux_cantus_firmus` | 0.943 | 0.947 | 0.004 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `salzer_schachter_cantus_firmus` | 0.947 | 0.950 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `diatonic_melody` | 0.915 | 0.922 | 0.008 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `arch_contour_melody` | 0.967 | 0.970 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `ascending_contour_melody` | 0.585 | 0.588 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `descending_contour_melody` | 0.585 | 0.588 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `static_contour_melody` | 0.585 | 0.588 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `valley_contour_melody` | 0.585 | 0.588 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-7-v0 | 13 | `wave_contour_melody` | 0.967 | 0.970 | 0.003 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-8-v0 | 11 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-8-v0 | 11 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-9-v0 | 11 | `fux_cantus_firmus` | 0.959 | 0.961 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-9-v0 | 11 | `salzer_schachter_cantus_firmus` | 0.961 | 0.964 | 0.002 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-10-v0 | 10 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `diatonic_melody` | 0.962 | 0.965 | 0.003 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `arch_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `ascending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `descending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `static_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `valley_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-11-v0 | 9 | `wave_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `fux_cantus_firmus` | 0.907 | 0.913 | 0.006 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `salzer_schachter_cantus_firmus` | 0.913 | 0.918 | 0.005 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `diatonic_melody` | 0.902 | 0.911 | 0.009 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `arch_contour_melody` | 0.963 | 0.966 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `ascending_contour_melody` | 0.581 | 0.584 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `descending_contour_melody` | 0.581 | 0.584 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `static_contour_melody` | 0.581 | 0.584 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `valley_contour_melody` | 0.581 | 0.584 | 0.003 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-12-v0 | 15 | `wave_contour_melody` | 0.963 | 0.966 | 0.003 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-13-v0 | 12 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-13-v0 | 12 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-14-v0 | 10 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-14-v0 | 10 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_cantus_firmus_examples_with_errors-15-v0 | 15 | `fux_cantus_firmus` | 0.998 | 0.998 | 0.000 | yes | demoted |
| fux_cantus_firmus_examples_with_errors-15-v0 | 15 | `salzer_schachter_cantus_firmus` | 0.998 | 0.998 | 0.000 | yes | demoted |
...
| fux_first_species_examples-0-v1 | 11 | `fux_cantus_firmus` | 0.908 | 0.914 | 0.006 | yes | demoted |
| fux_first_species_examples-0-v1 | 11 | `salzer_schachter_cantus_firmus` | 0.938 | 0.941 | 0.004 | yes | demoted |
...
| fux_first_species_examples-1-v1 | 11 | `fux_cantus_firmus` | 0.924 | 0.928 | 0.005 | yes | demoted |
| fux_first_species_examples-1-v1 | 11 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_first_species_examples-2-v1 | 11 | `fux_cantus_firmus` | 0.924 | 0.928 | 0.005 | yes | demoted |
| fux_first_species_examples-2-v1 | 11 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_first_species_examples-3-v1 | 10 | `fux_cantus_firmus` | 0.949 | 0.952 | 0.003 | yes | demoted |
| fux_first_species_examples-3-v1 | 10 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_first_species_examples-4-v1 | 10 | `fux_cantus_firmus` | 0.882 | 0.890 | 0.007 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `salzer_schachter_cantus_firmus` | 0.928 | 0.933 | 0.004 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `diatonic_melody` | 0.924 | 0.931 | 0.007 | yes | demoted |
...
| fux_first_species_examples-4-v1 | 10 | `arch_contour_melody` | 0.589 | 0.592 | 0.003 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `ascending_contour_melody` | 0.589 | 0.592 | 0.003 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `descending_contour_melody` | 0.589 | 0.592 | 0.003 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `static_contour_melody` | 0.589 | 0.592 | 0.003 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `valley_contour_melody` | 0.971 | 0.973 | 0.003 | yes | demoted |
| fux_first_species_examples-4-v1 | 10 | `wave_contour_melody` | 0.971 | 0.973 | 0.003 | yes | demoted |
...
| fux_first_species_examples-5-v1 | 10 | `fux_cantus_firmus` | 0.892 | 0.899 | 0.007 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `salzer_schachter_cantus_firmus` | 0.938 | 0.941 | 0.004 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `diatonic_melody` | 0.962 | 0.965 | 0.003 | yes | demoted |
...
| fux_first_species_examples-5-v1 | 10 | `arch_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `ascending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `descending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `static_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `valley_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
| fux_first_species_examples-5-v1 | 10 | `wave_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
...
| fux_first_species_examples-6-v1 | 12 | `fux_cantus_firmus` | 0.908 | 0.914 | 0.006 | yes | demoted |
| fux_first_species_examples-6-v1 | 12 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_first_species_examples-7-v1 | 12 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| fux_first_species_examples-8-v1 | 14 | `fux_cantus_firmus` | 0.867 | 0.875 | 0.008 | yes | demoted |
| fux_first_species_examples-8-v1 | 14 | `salzer_schachter_cantus_firmus` | 0.938 | 0.941 | 0.004 | yes | demoted |
...
| fux_first_species_examples-9-v1 | 14 | `fux_cantus_firmus` | 0.892 | 0.899 | 0.007 | yes | demoted |
| fux_first_species_examples-9-v1 | 14 | `salzer_schachter_cantus_firmus` | 0.961 | 0.964 | 0.002 | yes | demoted |
...
| fux_first_species_examples-10-v1 | 14 | `fux_cantus_firmus` | 0.924 | 0.928 | 0.005 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `salzer_schachter_cantus_firmus` | 0.952 | 0.955 | 0.003 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `diatonic_melody` | 0.962 | 0.965 | 0.003 | yes | demoted |
...
| fux_first_species_examples-10-v1 | 14 | `arch_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `ascending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `descending_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `static_contour_melody` | 0.603 | 0.605 | 0.001 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `valley_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
| fux_first_species_examples-10-v1 | 14 | `wave_contour_melody` | 0.985 | 0.987 | 0.001 | yes | demoted |
...
| fux_first_species_examples-11-v1 | 12 | `fux_cantus_firmus` | 0.924 | 0.928 | 0.005 | yes | demoted |
| fux_first_species_examples-11-v1 | 12 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| fux_first_species_examples-12-v1 | 12 | `fux_cantus_firmus` | 0.908 | 0.914 | 0.006 | yes | demoted |
| fux_first_species_examples-12-v1 | 12 | `salzer_schachter_cantus_firmus` | 0.961 | 0.964 | 0.002 | yes | demoted |
...
| clendinning_first_species_examples-0-v1 | 12 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| clendinning_first_species_examples-1-v1 | 9 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| clendinning_first_species_examples-2-v1 | 11 | `fux_cantus_firmus` | 0.949 | 0.952 | 0.003 | yes | demoted |
| clendinning_first_species_examples-2-v1 | 11 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| davis_and_lybbert_first_species_examples-0-v0 | 10 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
...
| davis_and_lybbert_first_species_examples-0-v1 | 10 | `fux_cantus_firmus` | 0.924 | 0.928 | 0.005 | yes | demoted |
| davis_and_lybbert_first_species_examples-0-v1 | 10 | `salzer_schachter_cantus_firmus` | 0.976 | 0.978 | 0.001 | yes | demoted |
...
| davis_and_lybbert_first_species_examples-1-v1 | 11 | `fux_cantus_firmus` | 0.975 | 0.976 | 0.002 | yes | demoted |
