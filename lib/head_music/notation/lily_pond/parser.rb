...
module HeadMusic::Notation::LilyPond
  ...
  #
  # The pipeline validates in stages — blank input, lexing, unsupported
  # tokens, delimiter balance, then the document's structure and every
  # pitch, duration, key, and meter — before a composition is built, so a
  # caller never receives a reference to a partially built composition.
  class Parser
    ...
    def build_composition
      ...
      ParsePreflight.reject_unsupported_tokens(tokens)
