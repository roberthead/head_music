...
describe HeadMusic::Rudiment::Sonority do
  describe "equality" do
    ...
    context "given a major triad" do
      ...
      context "when compared to another sonority with a different dominant seventh chord pitch set" do
        let(:other_pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[C E G]) }
        let(:other_sonority) { described_class.new(other_pitch_set) }
  ...
  describe ".for" do
    ...
    context "when given a simple dyad" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[C G]) }

      its(:identifier) { is_expected.to be_nil }
    end

    context "when given a major triad in root position" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[C E G]) }
    ...
    context "when given a major triad in first inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[E G C5]) }
    ...
    context "when given a major triad in second inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G3 C E]) }
    ...
    context "when given a minor triad in root position" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[C Eb G]) }
    ...
    context "when given a minor triad in first inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Eb G C5]) }
    ...
    context "when given a minor triad in second inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G3 C Eb]) }
    ...
    context "when given a diminished triad in root position" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[C Eb Gb]) }
    ...
    context "when given a diminished triad in first inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Eb Gb C5]) }
    ...
    context "when given an diminished triad in second inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Gb3 C Eb]) }
    ...
    context "when given an augmented triad in second inversion" do
      let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G#3 C E]) }
    ...
    context "when given a dominant seventh chord" do
      context "when in root position" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G3 B3 D F]) }
      ...
      context "when in first inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[B3 D F G]) }
      ...
      context "when in second inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[D F G B]) }
      ...
      context "when in third inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[F G B D5]) }
    ...
    context "when given a minor seventh chord" do
      context "when in root position" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G3 Bb3 D F]) }
      ...
      context "when in first inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Bb3 D F G]) }
      ...
      context "when in second inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[D F G Bb]) }
      ...
      context "when in third inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[F G Bb D5]) }
    ...
    context "when given a half-diminished seventh chord" do
      context "when in root position" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G3 Bb3 Db F]) }
      ...
      context "when in first inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Bb3 Db F G]) }
      ...
      context "when in second inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Db F G Bb3]) }
      ...
      context "when in third inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[F G Bb3 Db5]) }
    ...
    context "when given a fully-diminished seventh chord" do
      context "when in root position" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[G3 Bb3 Db Fb]) }
      ...
      context "when in first inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Bb3 Db Fb G]) }
      ...
      context "when in second inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Db Fb G Bb3]) }
      ...
      context "when in third inversion" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[Fb G Bb3 Db5]) }
    ...
    context "when given a dominant ninth chord" do
      context "when in root position" do
        let(:pitch_set) { HeadMusic::Rudiment::PitchSet.new(%w[C E G Bb D5]) }
