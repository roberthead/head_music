...
describe HeadMusic::Style::Guides::CombinedSecondThirdFourthSpeciesMelody do
  ...
  specify { expect(described_class::RULESET).to include HeadMusic::Style::Guidelines::AllowedRhythmicValuesForCombined234 }
  ...
  context "with a well-formed combined 2+3+4 species counterpoint" do
    ...
    before do
      ...
      # Mix of half notes, quarter notes, and tied notes
