...
describe HeadMusic::Style::Guides::SecondSpeciesMelody do
  ...
  specify { expect(guidelines_of(described_class)).to include HeadMusic::Style::Guidelines::FirstBarHalfNotes }
  specify { expect(guidelines_of(described_class)).to include HeadMusic::Style::Guidelines::NoRestsAfterNote }
  specify { expect(guidelines_of(described_class)).to include HeadMusic::Style::Guidelines::TwoPerBar }
