...
describe HeadMusic::Style::Guides::TripleMeterHarmony do
  ...
  specify { expect(described_class::RULESET).to include HeadMusic::Style::Guidelines::TripleMeterDissonanceTreatment }
