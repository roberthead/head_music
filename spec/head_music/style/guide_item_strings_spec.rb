...
GUIDE_ITEM_STRINGS = [
  ...
  ["AllowedRhythmicValuesForFifthSpecies", {}, "Use only permitted rhythmic values: whole (final bar only), half, quarter, or paired stepwise eighth notes on weak beats."],
  ...
  ["FloridDissonanceTreatment", {}, "Treat dissonances appropriately: passing tones, cambiata, or double neighbor on weak beats; proper suspension treatment for tied notes."],
  ["FourPerBar", {}, "Use four quarter notes in each middle bar."],
  ["FrequentDirectionChanges", {}, "Change melodic direction frequently."],
  ["LargeLeaps", {message: "Recover large leaps by step in the opposite direction.", minimum: :perfect_fourth, descending: {minimum: :perfect_fourth, forbidden: :minor_sixth}, recovery: [:consonant_triad, :opposite_step]}, "Recover large leaps by step in the opposite direction."],
  ...
  ["MinimumMelodicIntervals", {minimum: 1}, "Write at least one melodic intervals."],
  ...
  ["NoUnisonsInMiddle", {}, "Unisons may only be used in the first and last note."],
  ["NoteFillsFinalBar", {}, "End with a single note that fills the final bar."],
  ["NotesSameLength", {}, "Use consistent rhythmic unit."],
  ...
  ["PrepareOctaveLeaps", {}, "Enter and exit an octave leap from within."],
  ["SecondSpeciesBreak", {}, "Use only passing tones when breaking the syncopated texture. Breaks should be infrequent."],
  ...
  ["SingableRange", {}, "Limit melodic range to a 10th."],
  ...
  ["StepUpToFinalNote", {}, "Step up to final note."],
  ["SuspensionTreatment", {}, "Treat suspensions with proper preparation and downward stepwise resolution."],
