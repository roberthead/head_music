...
Two counterpoint stories, [Require the Species Rhythm](https://github.com/roberthead/head_music/tree/main/user-stories/done/require-the-species-rhythm.md) and [Embellish Fifth Species Suspensions](https://github.com/roberthead/head_music/tree/main/user-stories/done/embellish-fifth-species-suspensions.md). Every species guide now insists on the rhythm its species teaches, and fifth species accepts the decorated suspensions Fux allows. Two grades move, both in the direction the pedagogy says they should; everything else is additive, including ties across bar lines in ABC.
